  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-[#f8fafc] to-[#eef2f7] p-3 sm:p-4 flex items-start sm:items-center justify-center">
        <div className="receipt-print-area bg-white rounded-2xl shadow-lg max-w-md w-full overflow-hidden">
          ...
          <div className="p-5 sm:p-6 space-y-4">
            ...
            <button
              onClick={handlePrint}
              className="no-print block w-full text-center bg-[#f47b20] hover:bg-[#e06d1a] text-white py-3 rounded-lg font-bold text-sm transition"
            >
              Print / Save as PDF
            </button>
          </div>
