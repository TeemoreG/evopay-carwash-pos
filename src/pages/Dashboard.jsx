...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-800 p-3 sm:p-4 lg:p-6 space-y-3 sm:space-y-4">

      {/* Header */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 bg-white p-3 sm:p-4 rounded-xl border border-slate-200/80 shadow-sm">
        <div>
          <h1 className="text-lg sm:text-xl font-bold text-[#1a2a4a]">Car Wash POS</h1>
          <p className="text-slate-500 text-xs mt-0.5">Live overview of your wash business</p>
        </div>
        <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
          ...
          <button
            ...
            disabled={refreshing}
            className="flex items-center gap-1.5 px-2 py-1 text-xs font-medium text-slate-600 bg-slate-100 hover:bg-slate-200 rounded-lg border border-slate-200/60 disabled:opacity-50"
          >
            <RefreshCw className={`w-3.5 h-3.5 ${refreshing ? 'animate-spin' : ''}`} />
          </button>
          <div className="text-xs text-slate-600 bg-slate-50 px-2 py-1 rounded-lg border border-slate-200 font-medium flex items-center gap-1.5">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-2 sm:gap-3">
        <div className="bg-white p-3 sm:p-4 rounded-xl border border-slate-200/80 shadow-sm">
          ...
          <h3 className="text-lg sm:text-2xl font-extrabold text-[#1a2a4a] mt-1.5 tabular-nums break-words leading-tight">
        ...
        <div className="bg-white p-3 sm:p-4 rounded-xl border border-slate-200/80 shadow-sm">
          <div className="flex items-start justify-between gap-1">
            <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-wider text-slate-400">Washes</p>
            <div className="p-1.5 bg-orange-50 rounded-md">
              <Car className="w-4 h-4 text-[#f47b20]" />
            </div>
          </div>
        ...
        <div className="bg-white p-3 sm:p-4 rounded-xl border border-slate-200/80 shadow-sm">
          ...
          <h3 className={`text-lg sm:text-2xl font-extrabold mt-1.5 tabular-nums ${
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-4">
        ...
        <div className="lg:col-span-2 bg-white p-3 sm:p-4 rounded-xl border border-slate-200/80 shadow-sm">
        ...
        <div className="bg-white p-3 sm:p-4 rounded-xl border border-slate-200/80 shadow-sm">
          ...
          <p className="text-xs text-slate-400 mb-3">Washes by hour of day</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
        ...
        <div className="bg-white p-3 sm:p-4 rounded-xl border border-slate-200/80 shadow-sm">
          ...
          {salesByPayment.length > 0 ? (
            ...
            <div className="text-center py-6 text-slate-400 text-xs">No data yet</div>
          )}
        </div>
        ...
        <div className="bg-white p-3 sm:p-4 rounded-xl border border-slate-200/80 shadow-sm">
          ...
          <div className="grid grid-cols-3 gap-2 text-sm">
            <div className="text-center p-1.5 bg-slate-50 rounded-lg">
              ...
              <p className="font-bold text-slate-700 text-sm">{stats.totalCustomers}</p>
            </div>
            <div className="text-center p-1.5 bg-slate-50 rounded-lg">
              <p className="text-[10px] text-slate-400 uppercase">Cashiers</p>
              <p className="font-bold text-slate-700 text-sm">{stats.activeCashiers}</p>
            </div>
            <div className="text-center p-1.5 bg-slate-50 rounded-lg">
              <p className="text-[10px] text-slate-400 uppercase">Repeat</p>
              <p className="font-bold text-slate-700 text-sm">{repeatCustomerRate}%</p>
            </div>
          </div>

          <div className="flex items-center justify-between mt-2.5 p-2 bg-slate-50 rounded-lg">
            ...
            <span className={`inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[10px] font-medium ${
              ...
              {vscuStatus.checking ? <RefreshCw className="w-3 h-3 animate-spin" />
                : vscuStatus.connected ? <CheckCircle2 className="w-3 h-3" />
        ...
        <div className="bg-white p-3 sm:p-4 rounded-xl border border-slate-200/80 shadow-sm">
          ...
          {loading ? (
            ...
            <div className="text-center py-6 text-slate-400 text-xs">No product sales yet</div>
          ) : (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-4">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-slate-200/80 shadow-sm p-3 sm:p-4">
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="bg-white rounded-xl border border-slate-200/80 shadow-sm p-3 sm:p-4">
            ...
            {loading ? (
              ...
              <div className="text-center py-6 text-slate-400 text-xs">No service records</div>
            ) : (
              <div className="space-y-2.5">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center pt-2 border-t border-slate-200 text-xs text-slate-400 gap-1 text-center sm:text-left">
